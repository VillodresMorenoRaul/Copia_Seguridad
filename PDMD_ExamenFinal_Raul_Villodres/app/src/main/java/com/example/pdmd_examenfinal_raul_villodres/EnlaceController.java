...
public class EnlaceController {
    private com.example.pmdm_to03_raul_villodres.Activity3.dbHelper ayudanteBaseDeDatos;
    private String NOMBRE_TABLA = "enlaces";

    public EnlaceController(Context contexto){
        
        ayudanteBaseDeDatos = new com.example.pmdm_to03_raul_villodres.Activity3.dbHelper(contexto);
    }
