...
public class EditarEnlaceActivity extends AppCompatActivity {
    ...
    private com.example.pmdm_to03_raul_villodres.Activity3.EnlaceController enlacesController;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        enlacesController = new com.example.pmdm_to03_raul_villodres.Activity3.EnlaceController(com.example.pmdm_to03_raul_villodres.Activity3.EditarEnlaceActivity.this);
        ...
        // Listener del click del botón que guarda cambios
            ...
            public void onClick(View v) {
                ...
                if (filasModificadas != 1) {
                    Toast.makeText(com.example.pmdm_to03_raul_villodres.Activity3.EditarEnlaceActivity.this, "Error guardando cambios. Intente de nuevo.", Toast.LENGTH_SHORT).show();
                } else {
                    finish();
                }
            }
